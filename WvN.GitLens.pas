...
uses
  System.IOUtils, WvN.GitLens.Git.Blame, WvN.GitLens.Git.BlameParser;
...
begin
  ...
  begin
    ...
    CurrentUser.Name  :=  CaptureConsoleOutputSync('git config --global user.name');
    CurrentUser.Email := CaptureConsoleOutputSync('git config --global user.email');
